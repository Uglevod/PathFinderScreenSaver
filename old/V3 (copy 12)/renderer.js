class Renderer {
    ...
    drawStats(stats) {
        ...
        this.ctx.fillText(`Round: ${stats.rounds}`, 10, y);
        this.ctx.fillText(`Runners Escaped: ${stats.runnersEscaped}`, 10, y + 20);
        //this.ctx.fillText(`Runners Total: ${stats.runnersTotal}`, 10, y + 40);
        //this.ctx.fillText(`Time: ${stats.time}`, 10, y + 60);
